...
Page({
  ...
  getWrong() {
    var that = this;
    wx.request({
      url: `${app.globalData.http}api/v1/answer/getwrong/${app.globalData.testFlag}`,
      header: {
  ...
  changeC() {
    ...
    var that = this
    wx.request({
      url: `${app.globalData.http}api/v1/answer/collection/${app.globalData.testFlag}/${that.data.testId}`,
      header: {
        "Content-Type": "application/x-www-form-urlencoded",
